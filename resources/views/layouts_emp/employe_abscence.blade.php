            ...
            <form class="cmxform" method="post" action="{{'/mes_abscences/save_add'}}" enctype="multipart/form-data">
                ...
                <div class="modal-body"> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="form-group">Motif de l'abscence <span style="font-weight: normal;">(hors congés annuel)</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="form-group">Date de début d'abscence : </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="form-group">Heure de départ</label>
                    ...
                    <div style="font-size: 12px">
                        <span style="color: red; ">
                            Les abscences exceptionneles n'ouvrent pas droit à rémunération sauf dans le cas d'abscences pour évènements familiaux. <br/>
                        </span>
                        <span style="font-weight: bold">
                            évènements familiaux concernés:<br/>
                        </span>
                        
                        &nbsp;&nbsp;&nbsp;- Décès du père, de la mère, d'un enfant : <span style="font-weight: bold">5 jours</span> <br/>
                        ...
                        &nbsp;&nbsp;&nbsp;- Mariage d'un enfant, décès du frère, de la soeur, du beau-père, de la belle-mère : <span style="font-weight: bold">2 jours</span> <br/>
                        &nbsp;&nbsp;&nbsp;- Mariage du frère ou de la soeur : <span style="font-weight: bold">1 jour</span> <br/>
                        <span style="font-weight: bold; font-style: oblique">
                            La rémunératon n'est maintenue qu'à condition qu'un justificatif prouvant l'évènement, le lien de filiation ou de parenté (acte de naissance, acte de déccès, acte de mariage etc.) ait été transmis au service du personnel dans des délais raisonnables.  <br/>
                        </span>
                        <span style="color: red;">
                            La société décline toute resonsabilité en cas d'incident ou accident survenu au cours d'une abscence du salarié (abscence excetionnelle, congé annuel etc...).  <br/>
                        </span>
