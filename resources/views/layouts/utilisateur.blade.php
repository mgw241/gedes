            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <button class="btn btn-app bg-success tabBtnAdd" data-toggle="modal" {{ Session('permission')[0]->add =='0'?'disabled':''}} data-placement="right" title="Ajouter un utilsateur">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (Session('permission')[0]->edit == '1')
                                        <a class="tabBtnEdit" value="$user->id"  href="/access/utilisateurs/edituser/{{$user->id}}" data-placement="right" title="Editer"><i class="fas fa-lg fa-edit"></i></a>
                                    @endif

                                    @if (Session('permission')[0]->delete == '1')
                                        <a class="tabBtnDelete" id="{{$user->id}}" data-toggle="modal"><i class="fas fa-lg  fa-trash" data-placement="right" title="Supprimer"></i></a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
