...
@extends('client.apprh', ['titre' => 'Congés'])
                ...
                <nav class="navbar navbar-expand navbar-secondary navbar-dark justify-content-center">
                    ...
                    <ul class="navbar-nav justify-content-center">
                        <li class="nav-item d-none d-sm-inline-block">
                            <a href="/rh/abscences_conges/abscences" class="nav-link" data-toggle="tooltip" data-placement="right" title="Accéder aux abscences des employés">ABSCENCES</a>
                        </li>
                        <li class="nav-item d-none d-sm-inline-block">
                            <a href="/rh/abscences_conges/conges" class="btn btn-dark" data-toggle="tooltip" data-placement="right" title="Accéder aux congés des employés">CONGES</a>
                        </li>
                    </ul>
                  </nav>
                <div class="row">
                                ...
                                @foreach ($conges as $conge)
                                    <tr>
                                        <td class="t_matricule">
                                            <a href="/rh/employes/{{$conge->code_emp}}">
                                                {{$conge->code_emp}}
                                            </a>
...
<!-- Modal -->
    ...
    <div id="myModalADDConge" class="modal fade" role="dialog" data-backdrop="static">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h4 class="modal-title">Ajouter une prise de Congé</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
