            ...
            <div class="card card-primary card-outline">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item" style="text-align: center;margin-bottom:5px;margin-left:10px;margin-right:10px">
                        <a class="btn btn-primary btn-block btn-sm" style="margin-bottom: 5px;font-size: 15px;" href="/profil">GÉNERALITÉS</a>
                    </li>
                    <li class="nav-item" style="text-align: center;margin-bottom:5px;margin-left:10px;margin-right:10px">
                        <a class="btn btn-primary btn-block btn-sm"  href="/profil/carriere" style="margin-bottom: 5px;font-size: 15px;">CARRIÈRE</a>
                    </li>
                    <li class="nav-item" style="text-align: center;margin-bottom:5px;margin-left:10px;margin-right:10px">
                        <a class="btn btn-primary btn-block btn-sm"  href="/profil/salaire" style="margin-bottom: 5px;font-size: 15px;">SALAIRE</a>
                    </li>
                    <li class="nav-item" style="text-align: center;margin-bottom:5px;margin-left:10px;margin-right:10px">
                        <a class="btn btn-primary btn-block btn-sm" href="/profil/conge" style="margin-bottom: 5px;font-size: 15px;">CONGÉS</a>
                    </li>
                    <li class="nav-item" style="text-align: center;margin-bottom:5px;margin-left:10px;margin-right:10px">
